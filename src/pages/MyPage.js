      ...
      <Row>
        ...
        <Col xl={12} lg={12} md={12}>
          ...
          <Link className={'form-control'} color="link" to="/my/account"  ><FaShieldAlt className='mr-3' /> Acount Security</Link>
           <Link className={'form-control'}  color="link" to="https://gonativeio.s3.amazonaws.com/static/635ed61e45be842603b4aa03/app-release.apk"><FaDownload className='mr-3' /> App Download</Link>
